...
&НаКлиенте
Процедура РасставитьМетаданные(Команда)
	
	РазобратьМетаданные_Сервер(Элементы.Список.ВыделенныеСтроки);
	
КонецПроцедуры   

&НаСервере
Процедура РазобратьМетаданные_Сервер(знач МассивСсылок)
